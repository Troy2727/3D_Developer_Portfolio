...
export function Room(props) {
  ...
  return (
    <group {...props} dispose={null}>
      {/* Add a light specifically for the screens that need bloom */}
      <spotLight
        position={[0, 2, 5]}
        angle={0.5}
        penumbra={0.5}
      ...
      {/* Only use EffectComposer when not on mobile to improve performance */}
      {typeof window !== 'undefined' && window.innerWidth > 768 && (
        <EffectComposer>
          <SelectiveBloom
            ...
            lights // Include scene lights in the effect
          />
        </EffectComposer>
      )}
      <mesh
